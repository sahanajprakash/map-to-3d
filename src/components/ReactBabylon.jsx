...
const SpinningBox = (props) => {
  ...
  useEffect(() => {
      if (props.textureUrl && textureRef.current) {
          const texture = new Texture(props.textureUrl, props.scene);
          
          textureRef.current.diffuseTexture = texture;
          console.log('updating', textureRef);
    }
  }, [props.textureUrl, props.scene]);
...
export const BabylonJSComponent = ({capturedImageData}) => (
    <div>
